             ...
             <form method="post" action="action.php">
               <table>
                 ...
                 <tr>
                   ...
                   <td><b>Study:</b>&emsp;&emsp;&emsp;Nurse<input type="hidden" name="study" value="gynaec"><input type="hidden" name="rkey" value="<?php echo $rkey; ?>" ></td>
                 </tr>
               </table><br/><br/>
               <h6>Dialysis Form</h6>
               <table>
                 ...
                 <tr>
                   ...
                   <td style="letter-spacing:1px;">&emsp;<b><input type="radio" name="uterus" value="high" <?php if($uappear == "antiverted"){echo "checked";} ?>/>high</b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="radio" name="uterus" value="low" <?php if($uappear == "retroverted"){echo "checked";} ?>/>low</b></td>
                 </tr>
                 <tr>
     ...
     <td>
       <div class="form-style-8 scroll" style="width: 90%;padding-top:0px;">
             ...
             <form method="post" action="action.php">
               ...
               <h6>Haemo-Dialysis Form</h6>
               <table>
                 <tr>
                   <td style="letter-spacing:2px;"><b>Sonography : </b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="checkbox" name="transAbdorminal" value="yes" <?php if ($tabdominal == "yes") {echo "checked";} ?>/>Trans-Abdorminal</b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="checkbox" name="transVaginal" value="yes" <?php if($tvaginal == "yes"){echo "checked";} ?>/>Trans-Vaginal</b></td>
                 </tr><tr></tr>
                 <tr>
     ...
     <td>
       <div class="form-style-8 scroll" style="width: 90%;padding-top:0px;">
             ...
             <form method="post" action="action.php">
               ...
               <table width="100%" style="border-collapse:collapse" border="1">
                 <tr>
                   <td rowspan="2" width="10%">Date</td><td rowspan="2">Day</td><td colspan="2" align="center">Dominant Follicle</td><td rowspan="2">Haemoglobin</td>
                 </tr>
                 <tr>
                   <td align="center">Right ovary</td><td align="center">Left ovary</td>
                 </tr>
