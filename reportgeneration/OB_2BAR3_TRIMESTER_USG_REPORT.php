...
<center>
  ...
  <p align="left"style="padding-left:5%; padding-right:5%;">Real time B mode sonography of pelvis, showed Gravid uterus with Single/<br/>
    ...
    <table width="50%" align="center" style="border-collapse: collapse;" border="1">
      <tr>
        <td width="30%" style="border:1px solid; ">&emsp;<b>BPD </b></td>
        <td style="border:1px solid; "><?php echo $bpd; ?></td>
        <td width="53%"style="border:1px solid; ">&emsp;<?php echo $bpdwd; ?></td>
      </tr>
      <tr>
        <td style="border:1px solid; ">&emsp;<b>HC</b></td>
        <td style="border: 1px solid; border-left:0px; color:#0a7b70"><?php echo $hc; ?></td>
        <td style="border:1px solid; ">&emsp;<?php echo $hcwd; ?></td>
      </tr>
      <tr>
        <td style="border:1px solid; ">&emsp;<b>AC</b></td>
        <td style="border:1px solid; "><?php echo $ac; ?></td>
        <td style="border:1px solid; ">&emsp;<?php echo $acwd; ?></td>
      </tr>
      <tr>
        <td style="border:1px solid; ">&emsp;<b>FL</b></td>
        <td style="border:1px solid; "><?php echo $fl; ?></td>
        <td style="border:1px solid; ">&emsp;<?php echo $flwd; ?></td>
      </tr>
    </table><br/>
    ...
    <tr>
      ...
      <tr>
        ...
        <td align="center" colspan="2">
          <p style="width: 100%;  bottom: 10px;letter-spacing:0px;  border-top: 1px solid; " align="center">
            <i>
