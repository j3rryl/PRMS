       ...
       <div class="form-style-8 scroll" style="width: 90%;padding-top:0px;">
             ...
             <form method="post" action="action.php">
               ...
               <table>
                 ...
                 <tr>
                   <td style="letter-spacing:2px;"><b>Potaasium: </b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="radio" name="uterus" value="high" checked/>high</b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="radio" name="uterus" value="low"/>low</b></td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   <td><b></b></td>
                   <td colspan="2"><input type="text" name="lom" value="0 X 0 X 0" placeholder="" value=""/></td>
                 </tr>
                 <tr>
               ...
               <table width="100%">
                 <tr>
                   <td><input type="text" name="impression"/></td>
                 </tr>
               </table>
               <br/>
               <input type="submit" value="submit" name="pelvistwo"/>
             </form>
             <form method="post" action="action.php">
               <input type="hidden" name="rtype" value="pelvistwo"/>
             ...
             <form method="post" action="undo.php">
              <input type="hidden" name="attendant" value="<?php  if(!isset($_SESSION)) {session_start();}$user = $_SESSION["username"];echo $user;?>"/>
              <input style="position:absolute; top: 3%;right:45px;" type="submit" value="undo changes" name="pelvistwo"/>
             </form>
           </div>
     </td>
   </tr>
