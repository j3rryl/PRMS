...
<center>
  ...
  <u style="color:#21618c;"><h2 style="color: #21618c;">OB First Trimester USG Report</h2></u>
...
<table width="100%" >
  <tr>
    <td><font style="color: #21618c;"><b>LMP</b>:</font>   <?php if($lmp!=''){ echo date('d/m/Y',strtotime($lmp));} ?></td>
    <td><font style="color: #21618c;"><b>GA</b>(LMP)</font>:  <font style="padding:0px 10px; border-bottom:1px solid;"><?php echo $lmpga; ?></font></td>
