             ...
             <form method="post" action="action.php">
               <table>
                 ...
                 <tr>
                   ...
                   <td><b>Study:</b>&emsp;&emsp;&emsp;Nurse<input type="hidden" name="study" value="Nurse"><input type="hidden" name="rkey" value="<?php echo $rkey; ?>"></td>
                 </tr>
               </table><br/><br/>
               <h6>Dialysis Form</h6>
               <table>
                 <tr>
                   ...
                   <td style="letter-spacing:1px;">&emsp;<b><input type="checkbox" name="high" value="yes"/>High</b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="checkbox" name="low" value="yes"/>Low</b></td>
                 </tr><tr></tr>
                 <tr>
                   <td style="letter-spacing:2px;"><b>Potassium: </b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="radio" name="high" value="antiverted" checked/>high</b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="radio" name="low" value="retroverted"/>low</b></td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   <td><b>Weight:</b></td>
                   <td colspan="2"><input type="text" name="rom" value="0 X 0 X 0" placeholder="IN Kg." value=""/></td>
                 </tr>
                 <tr>
