     ...
     <td>
       <div class="form-style-8 scroll" style="width: 90%;padding-top:0px;">
             ...
             <form method="post" action="action.php">
               ...
               <table>
                 <tr>
                   <td style="letter-spacing:2px;"><b>Calcium: </b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="checkbox" name="high" value="yes" <?php if ($tabdominal == "yes") {echo "checked";} ?>/>high</b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="checkbox" name="low" value="yes" <?php if($tvaginal == "yes"){echo "checked";} ?>/>Low</b></td>
                 </tr><tr></tr>
                 <tr>
                   <td style="letter-spacing:2px;"><b>Potassium: </b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="radio" name="uterus" value="high" <?php if($uappear == "high"){echo "checked";} ?>/>high</b></td>
                   <td style="letter-spacing:1px;">&emsp;<b><input type="radio" name="uterus" value="low" <?php if($uappear == "low"){echo "checked";} ?>/>low</b></td>
                 </tr>
                 <tr>
                   <td><b>Urine Test:</b></td>
                   <td><input type="text" name="um" value="<?php echo $umeasure; ?>" readonly/></td>
                   <td><b></b></td>
                 </tr>
                 <tr>
                   <td style="letter-spacing:2px;"><b>Creatinine: </b></td>
                 ...
                 <tr>
                   <td><b>Weight:</b></td>
                   <td colspan="2"><input type="text" name="rom" value="<?php echo $rom; ?>" placeholder="IN KG." readonly/></td>
                 </tr>
                 <tr>
                   <td style="letter-spacing:2px;"><b>Blood Pressure: </b></td>
                 ...
                 <tr>
                   <td><b></b></td>
                   <td colspan="2"><input type="text" name="lom" value="0 X 0 X 0" placeholder="" value=" <?php echo $lom; ?>"/></td>
                 </tr>
                 <tr>
                   <td style="letter-spacing:2px;"><b>Appeareance: </b></td>
               ...
               <table width="100%" style="border-collapse:collapse" border="1">
                 <tr>
                   <td rowspan="2" width="10%">Date</td><td rowspan="2">Day</td><td colspan="2" align="center">Dominant Elements</td><td rowspan="2">Haemoglobin</td>
                 </tr>
                 <tr>
                   <td align="center">Sodium</td><td align="center">Blood Pressure</td>
                 </tr>
                 <tr>
       ...
       <div class="form-style-8 scroll" style="width: 90%;padding-top:0px;">
             ...
             <form method="post" action="action.php">
               ...
               <table width="100%" style="border-collapse:collapse" border="1">
                 ...
                 <tr>
                    <td><input type="date" name="date4" value="<?php echo $dte4; ?>" autofocus="true" readonly/></td>
